...
#${CASC} -t txt -f GameStrings -x -v

#${CASC} -t dds -s mods/heroes.stormmod/base.stormassets/Assets/Textures -f storm_btn_d3_ -x -v
...
#${CASC} -s mods/heroesdata.stormmod/enus.stormdata/LocalizedData/GameStrings.txt -x
