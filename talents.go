...
var talentData = map[string]talentText{
	...
	"AbathurSymbioteCarapaceSustainedCarapace": {
		...
		Text: "Increases the Shield amount of Symbiote's Carapace by 40.0% and allows it to persist after Symbiote ends.",
	},
	...
	"ArtanisBladeDashTemplarsZeal": {
		Name: "Templar's Zeal",
		Text: "Blade Dash cooldown recharges 150.0% faster while below 50% Health.",
	},
	...
	"AurielEnergizedCordRayOfHeavenTalent": {
		Name: "Energized Cord",
		Text: "Increases the energy stored from Auriel's Basic Attacks to 50.5% of the damage against Heroes and 45.0% of the damage against non-Heroes.\nDoes not affect Auriel's Bestow Hope ally.",
	},
	...
	"AurielMajesticSpanSacredSweepTalent": {
		Name: "Majestic Span",
		Text: "Increases the radius of Sacred Sweep by 15.0%.",
	},
	...
	"BrightwingUnfurlingSpraySoothingMist": {
		...
		Text: "Increases Soothing Mist's range by 20.0%.",
	},
	...
	"ChenFlyingLeap": {
		Name: "Flying Leap",
		Text: "Increases Flying Kick's range by 15.0%.",
	},
	...
	"ChenHeroicAbilityWanderingKeg": {
		Name: "Wandering Keg",
		Text: "Roll around inside an Unstoppable barrel with 60.0% increased Movement Speed, dealing 59 damage to enemies in the way and knocking them back. Lasts for 5 seconds.",
	},
	"ChenKegToss": {
		Name: "Keg Toss",
	...
	"ChenMasteryWanderingKegUntappedPotential": {
		...
		Text: "Wandering Keg increases Movement Speed by 60.0% and grants 50 Armor, reducing damage taken by 50%.",
	},
	"ChenPressurePoint": {
		Name: "Pressure Point",
	...
	"ChoUppercut": {
		Name: "Uppercut",
		Text: "Surging Fist deals additional damage to Heroes equal to 7.0% of their max Health.",
	},
	"ChromieBronzeTalons": {
		Name: "Bronze Talons",
	...
	"CrusaderMasteryIronSkinHoldYourGround": {
		...
		Text: "Increases Iron Skin's Shield by 30.0% and its cooldown is reduced by 4 seconds.",
	},
	...
	"DVaBoostersComingThrough": {
		Name: "Coming Through",
		Text: "Knockback distance of Boosters is increased by -95.5%.",
	},
	...
	"DVaBoostersHitTheNitrous": {
		...
		Text: "Initial speed bonus of Boosters is increased to -95.7%, then decays to normal boost speed over 0.5 seconds. During this time, Boosters deals 102.5% extra damage.",
	},
	"DVaBoostersRushdown": {
		Name: "Rush-down",
	...
	"DVaPilotNanoweaveSuit": {
		Name: "Nanoweave Suit",
		Text: "For 4 seconds after ejecting from her Mech, D.Va gains 50 Armor and her Basic Attacks grant 0.0% more cooldown reduction towards Call Mech.",
	},
	...
	"GarroshBloodthirstBloodcraze": {
		Name: "Bloodcraze",
		Text: "When hitting a Hero, Bloodthirst heals for an additional 8.2% of Garrosh's maximum Health over 3 seconds.",
	},
	...
	"GarroshWreckingBallEarthshaker": {
		Name: "Earthshaker",
		Text: "Wrecking Ball Stuns enemies near the impact area for 0.8 seconds.",
	},
	...
	"GenericTalentFirstAid": {
		Name: "First Aid",
		Text: "Activate to heal 11.1% of your max Health over 6 seconds.",
	},
	...
	"GenericTalentPromote": {
		Name: "Promote",
		Text: "Activate to cause an allied lane Minion to take -24% reduced damage from non-Heroic targets and deal 100% bonus damage to non-Heroic targets for 30 seconds. Has 2 charges.",
	},
	...
	"GenjiDeflectReflect": {
		Name: "Reflect",
		Text: "Deflect also deals an additional -66% of the damage blocked.",
	},
	"GenjiDeflectZanshin": {
		Name: "Zanshin",
	...
	"JunkratFragLauncherCannonball": {
		Name: "Cannonball!",
		Text: "Increase the radius and explosion radius of grenades from Basic Attacks and Frag Launcher by -98.5%.",
	},
	...
	"JunkratFragLauncherTasteForExplosions": {
		...
		Text: "Quest: Hitting a Hero with Frag Launcher increases its damage by 0.8, up to 150.",
	},
	...
	"LeoricMasteryOsseinRenewal": {
		Name: "Ossein Renewal",
		Text: "Activate to heal Leoric for 30.0% of his maximum Health over 5 seconds. Regeneration Globes lower the cooldown of this Ability by 20 seconds.",
	},
	...
	"LeoricSkeletalSwingKneelPeasantsTalent": {
		Name: "Kneel, Peasants!",
		Text: "Skeletal Swing deals 75% more damage to Minions, Mercenaries, and Monsters.",
	},
	...
	"LucioSoundwaveChaseTheBassQuest": {
		Name: "Chase the Bass",
		Text: "Quest: Hit 20 enemy Heroes with Soundwave.\nReward: Increase Soundwave's arc by 50.0% and its range by 20%.",
	},
	...
	"LucioWallRideAccelerando": {
		Name: "Accelerando",
		Text: "Wall Ride's Movement Speed bonus gradually increases to 20.2% over 4 seconds while Lúcio maintains its effect.",
	},
	...
	"LucioWallRideSlip": {
		Name: "Slip",
		Text: "Passing through or near an enemy Hero during Wall Ride's effect increases its Movement Speed bonus to 22.2% for 1 second.",
	},
	...
	"MedicExtendedCare": {
		Name: "Extended Care",
		Text: "Increase the range of Healing Beam by 40.0%.",
	},
	"MedicFirstResponder": {
	...
	"MonkEchoofHeavenBreathofHeaven": {
		Name: "Echo of Heaven",
		Text: "Breath of Heaven heals -24% of its normal amount, but heals a second time 3 seconds later.",
	},
	...
	"MonkHeavenlyZealBreathofHeaven": {
		Name: "Heavenly Zeal",
		Text: "Increases Breath of Heaven's Movement Speed bonus to 15.2%.",
	},
	...
	"MonkHeroicAbilitySevenSidedStrike": {
		...
		Text: "Become Invulnerable and strike 7 times over 1.8 seconds. Each strike hits the highest Health nearby Hero for 7.0% of their maximum Health.",
	},
	"MonkInsight": {
		Name: "Insight",
		Text: "Quest: Every 3rd Basic Attack restores 14 Mana and grants a stack of Insight. \nReward: Upon getting 100 stacks of Insight, every 3rd attack also reduces the cooldown of all of Kharazim's Basic Abilities by 1.8 seconds.",
	},
	"MonkIronFists": {
		Name: "Iron Fists",
		Text: "Every 3rd Basic Attack deals 110.0% bonus damage and gives 30% increased Move Speed for 2 seconds.",
	},
	...
	"MonkTranscendence": {
		Name: "Transcendence",
		Text: "Every 3rd Basic Attack heals the lowest nearby allied Hero for 103.",
	},
	...
	"MuradinCombatStyleSkullcracker": {
		Name: "Skullcracker",
		Text: "Every 3rd Basic Attack against the same enemy deals 60% bonus damage and Stuns them for 0.2 seconds.",
	},
	"MuradinCombatStyleThirdWind": {
		Name: "Third Wind",
		Text: "Increases Health Restoration rate to 80 per second, and raises Health threshold to 60% Health for improved 159 per second Restoration.",
	},
	...
	"MuradinMasteryDwarfTossHeavyImpact": {
		Name: "Heavy Impact",
		Text: "Enemies hit by Dwarf Toss are stunned for 0.5 seconds.",
	},
	...
	"MuradinMasteryStormhammerSledgehammer": {
		Name: "Sledgehammer",
		Text: "Deals 201% damage to non-Heroic enemies. Destroys 4 ammo from Structures.",
	},
	...
	"MurkyTimetoKrill": {
		Name: "Time to Krill",
		Text: "Basic Attacks against Heroes deal an additional 7 damage a second and slow the target by 7.0% for 4 seconds. This effect can stack up to 5 times.",
	},
	"MurkyToxicBuildup": {
		Name: "Toxic Buildup",
	...
	"NecromancerTalentEchoesOfDeath": {
		...
		Text: "Spectral Scythe spawns 2 additional scythes next to the first after 1.5 seconds, dealing -39% damage.",
	},
	...
	"NovaCovertOps": {
		Name: "Covert Ops",
		Text: "After being Stealthed for 5 seconds, Pinning Shot's slow is increased to 55.0% and costs no Mana. Bonus is lost after losing Stealth for 1 second.",
	},
	"NovaGhostProtocol": {
		Name: "Ghost Protocol",
	...
	"ProbiusEchoPulseDisruptionPulse": {
		Name: "Echo Pulse",
		Text: "Disruption Pulse now returns to Probius 1.2 seconds after reaching its target, dealing -24% damage on the return trip.",
	},
	...
	"ProbiusRiftShockWarpRift": {
		Name: "Rift Shock",
		Text: "Hitting an enemy Hero with Warp Rift explosion increases Probius's damage against them by 20.0% for 10 seconds.",
	},
	...
	"ProbiusShootEmUptoRiftsDisruptionPulse": {
		Name: "Shoot 'Em Up",
		Text: "Hitting a Warp Rift with Disruption Pulse causes 4 additional pulses that deal -49% damage to be fired from the impact location in different directions.  \nAdditional Pulses do not benefit from Echo Pulse or Particle Accelerator.",
	},
	...
	"ProbiusTurboChargedWorkerRush": {
		Name: "Turbo Charged",
		Text: "Worker Rush grants an additional 10.0% passive Movement Speed while in a Power Field, and its cooldown is reduced by 10 seconds.",
	},
	...
	"RagnarosBlastWaveSuperheated": {
		Name: "Superheated",
		Text: "When Blast Wave is used on Ragnaros, it deals -98% increased damage.",
	},
	...
	"RehgarMasteryGladiatorsWarShout": {
		...
		Text: "Increases Bloodlust's healing from 30% to 30.3% of Basic Attack damage done.",
	},
	...
	"RehgarMasteryWolfRun": {
		Name: "Wolf Run",
		Text: "Increases the Movement Speed of Ghost Wolf from 20% to 30.0%.",
	},
	"RehgarRisingStorm": {
		Name: "Rising Storm",
	...
	"StitchesPotentBile": {
		Name: "Potent Bile",
		Text: "Putrid Bile lasts 6 seconds longer and its slow amount is increased from 35% to 45.0%.",
	},
	...
	"StukovWithinMyReach": {
		...
		Text: "Increase the range of Lurking Arm by -98.5%.",
	},
	...
	"TassadarPsionicStormPsiInfusion": {
		Name: "Psi-Infusion",
		Text: "Quest: Gain 1 Mana for every non-Structure enemy hit by Psionic Storm.\nReward: After hitting 500 enemies, increase the size of Psionic Storm by -98.8%.\nReward: After hitting 1000 enemies, increase the damage of Psionic Storm by -98.8%",
	},
	"TassadarResonation": {
		Name: "Resonation",
	...
	"TinkerMasteryRockitTurretXL": {
		...
		Text: "Rock-It! Turrets attack up to 2 additional enemies for 60.0% damage.",
	},
	...
	"TracerBulletSprayMelee": {
		Name: "Bullet Spray",
		Text: "Increases Melee's radius by -98.7%, and causes it to damage all enemies in range.",
	},
	"TracerBulletTime": {
		Name: "Bullet Time",
	...
	"TracerPulseStrikeMelee": {
		Name: "Pulse Strike",
		Text: "Increases Melee's Pulse Bomb charge from 10% to 1010% against Heroes.",
	},
	"TracerQuantumSpike": {
		Name: "Quantum Spike",
	...
	"TracerStickyBomb": {
		Name: "Sticky Bomb",
		Text: "Increases Pulse Bomb's radius by -98.5% and enemies hit are slowed by 70% for 3 seconds.",
	},
	...
	"TychusInTheRhythm": {
		Name: "In the Rhythm",
		Text: "Quest: While Minigun is active, Basic Attacks against Heroes permanently increase future Minigun durations by 0.0 seconds.",
	},
	...
	"UtherMasteryRedemption": {
		Name: "Redemption",
		Text: "After Eternal Vanguard ends, Uther revives at the spirit's location with -49% of his maximum Health.\nThis effect has a 180 second cooldown.",
	},
	...
	"ValeeraAmbushAssassinate": {
		Name: "Assassinate",
		Text: "Ambush deals 199% additional damage if no other enemy Heroes are within 4 range of the victim.",
	},
	...
	"ValeeraGarroteRupture": {
		Name: "Rupture",
		Text: "Valeera's Basic Attacks increase the damage over time effect of Garrote by 5%, stacking up to 30.0%, and refresh the duration.",
	},
	...
	"WitchDoctorSoulHarvest": {
		Name: "Soul Harvest",
		Text: "Activate to increase Nazeebo's Health and Spell Power by 7.0% for each nearby enemy, up to a maximum of 35.0%. Lasts 15 seconds.",
	},
	...
	"ZaryaEnergyBornInBattle": {
		Name: "Born in Battle",
		Text: "While at or above 75 Energy, Zarya's cooldowns regenerate -98.8% faster.",
	},
	...
	"ZaryaWeaponToTheLimit": {
		Name: "To the Limit",
		Text: "While above 50 Energy, Zarya's Basic Attack size is increased by -98.7%.",
	},
	"ZeratulComboSlash": {
		Name: "Combo Slash",
	...
	"ZuljinBoneslicer": {
		Name: "Boneslicer",
		Text: "Grievous Throw now pierces through all enemies hit and restores 10 Mana per Hero hit. Additionally, Grievous Throw's mark is no longer removed by Basic Attacks.",
	},
	"ZuljinBuzzsaw": {
		Name: "Buzzsaw",
	...
	"ZuljinEyeOfZuljin": {
		Name: "Eye of Zul'jin",
		Text: "Basic Attacks against enemy Heroes grant Zul'jin 3% Movement Speed for 2 seconds, up to 30%.",
	},
	"ZuljinFerocity": {
		Name: "Ferocity",
		Text: "Increases the Attack Speed bonus of Berserker by 35%.",
	},
	...
	"ZuljinViciousAssault": {
		...
		Text: "Increase Grievous Throw's damage bonus by 30%.",
	},
	"ZuljinVoodooShuffle": {
		Name: "Voodoo Shuffle",
